    ...
    <div className="flex-1 w-full bg-mesh min-h-screen">
      ...
      <div className="relative overflow-hidden pt-16 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-top-8 duration-1000">
          ...
          <div className="mt-16 relative group w-[300px] h-[300px] mx-auto animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
            ...
            <div className="relative bg-white p-2 rounded-[2.5rem] shadow-2xl border-4 border-white overflow-hidden h-full flex items-center justify-center">
              <Image 
