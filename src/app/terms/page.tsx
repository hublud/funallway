          ...
          <div className="pt-12 border-t border-slate-100">
            <div className="bg-blue-600 p-8 rounded-3xl text-white shadow-xl shadow-blue-200">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <Link href="mailto:legal@funalltheway.com" className="bg-white text-slate-900 px-6 py-3 rounded-2xl font-black flex items-center gap-2 hover:bg-slate-100 transition shadow-lg shrink-0">
